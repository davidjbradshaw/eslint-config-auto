...
The [eslint-config-adjunct](https://github.com/davidjbradshaw/eslint-config-adjunct) config is included, this will install a range of plugins based on your project config.
